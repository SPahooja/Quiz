...
The CSV file should default to `sample.csv` (example shown below), but the user should be able to customize the filename via a flag.
...
Adapt your program from to add a timer. The default time limit should be 30 seconds, but should also be customizable via a flag.
